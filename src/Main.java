...
public class Main {
    public static void main(String[] args) {
        ...
        List<Person> thirdList = persons.stream()
                .filter(person ->
                        person.getSex().equals(Sex.WOMAN) && person.getAge() >= 18 && person.getAge() < 60 && person.getEducation().equals(Education.HIGHER)
                        || person.getSex().equals(Sex.MAN) && person.getAge() >= 18 && person.getAge() < 65 && person.getEducation().equals(Education.HIGHER) )
